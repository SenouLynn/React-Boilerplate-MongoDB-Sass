...
export default function Projects(props) {
    ...
    const projectShowcase = [
        ...
        },
        {
            "name": "Yelpington",
            "gif": yelpington,
            "description": "A single-page React-app with an express back-end managing API calls to MongoDB creating a persistent review application along with an integrated Leaflet's map viewport",
    ...
    let projectGridBuilder = projectShowcase.map((project) => {
        ...
        return (
            <div key={project.name + projectShowcase.indexOf(project)} className="grid-item-mobile card-flip">
